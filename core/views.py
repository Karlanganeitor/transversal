...
def eliminarProductoAdmin(request ,id):
    ...
    return redirect(to= "core:listarProductoAdmin")
#MOSTRAR LA LISTA DE LOS PRODUCTOS VISTA
...
#QUE SE AGREGUE 1 PRODUCTO AL CARRITO
